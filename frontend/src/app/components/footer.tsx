...
export default function Footer() {
  const teamMembers = [
    { name: "Joseph", role: "Team Lead", git: "https://github.com/Psychecj" },
    { name: "Ahamada  ", role: "Product Developer", git: "https://github.com/Ahmad-nba" },
    { name: "Oscar", role: "Documentation Specialist", git: "https://github.com/kiwalabyeo" },
    { name: "Aaron", role: "Testing and QA", git: "https://github.com/placeholder" },
    { name: "Evalister", role: "Testing and QA", git: "https://github.com/placeholder2" },
  ];
